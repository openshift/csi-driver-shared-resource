...
func TestBuildTLSConfigFromFlags(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			cipherSuitesFlag: "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256",
			wantMinVersion:   cryptotls.VersionTLS12,
		...
		},
		{
			...
			cipherSuitesFlag:    "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256",
		...
		},
		{
			...
			minVersionFlag:   "VersionTLS12",
			cipherSuitesFlag: "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256",
			wantMinVersion:   cryptotls.VersionTLS12,
			wantCipherSuites: []uint16{cryptotls.TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, cryptotls.TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, cryptotls.TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256},
		},
		{
			name:             "unsupported cipher suites are skipped",
			minVersionFlag:   "VersionTLS12",
			cipherSuitesFlag: "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,UNSUPPORTED-CIPHER,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256",
			wantMinVersion:   cryptotls.VersionTLS12,
			wantCipherSuites: []uint16{cryptotls.TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, cryptotls.TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256},
		},
		{
		...
		{
			name:             "CBC mode cipher suites are rejected (Lucky13 vulnerability)",
			minVersionFlag:   "VersionTLS12",
			cipherSuitesFlag: "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256,TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256,TLS_RSA_WITH_AES_128_CBC_SHA256",
			wantErr:          true,
		},
		{
			name:             "static RSA cipher suites are rejected (no forward secrecy)",
			minVersionFlag:   "VersionTLS12",
			cipherSuitesFlag: "TLS_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_256_GCM_SHA384",
			wantErr:          true,
		},
		{
			name:             "SHA-1 cipher suites are rejected",
			minVersionFlag:   "VersionTLS12",
			cipherSuitesFlag: "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA,TLS_RSA_WITH_AES_128_CBC_SHA",
			wantErr:          true,
		},
		{
			name:             "3DES cipher suite is rejected",
			minVersionFlag:   "VersionTLS12",
			cipherSuitesFlag: "TLS_RSA_WITH_3DES_EDE_CBC_SHA",
			wantErr:          true,
		},
		{
			name:             "insecure ciphers mixed with secure ciphers only accepts secure",
			minVersionFlag:   "VersionTLS12",
			cipherSuitesFlag: "TLS_RSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256",
			wantMinVersion:   cryptotls.VersionTLS12,
			wantCipherSuites: []uint16{cryptotls.TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, cryptotls.TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256},
		},
	}
